// From https://vulkan-tutorial.com/code/15_hello_triangle.cpp
...
private:
    ...
    void mainLoop()
    {
        ...
        while (!glfwWindowShouldClose(window) && !quit_loop) {
            glfwPollEvents();
            drawFrame();
        }
    ...
    {
        auto vertShaderCode = readFile(SHADERDIR "vert.spv");
        auto fragShaderCode = readFile(SHADERDIR "frag.spv");
    ...
    bool checkDeviceExtensionSupport(VkPhysicalDevice physdev)
    {
        ...
        vkEnumerateDeviceExtensionProperties(
            physdev, nullptr, &extensionCount, availableExtensions.data());
